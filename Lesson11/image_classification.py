...
from Lesson11.networks import Network
from Lesson11.config import cfg
from Lesson11.data_loader import DataLoader
from Lesson11.custom_accuracy import CustomSparseCategoricalAccuracy
...
class ImageClassification:
    ...
    def __build_model(self):
        ...
        self.net.build((None, cfg.train.image_size,  cfg.train.image_size, 3))
        self.net.summary()
    ...
    def run_train_epoch(self, epoch):
        ...
        for images, labels in self.data_loader.dataset:
            with tf.GradientTape() as tape:
                ...
                self.category_metric.update_state(labels, predictions)
                self.custom_category_metric.update_state(labels, predictions)
